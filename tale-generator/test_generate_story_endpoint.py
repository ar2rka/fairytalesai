"""Test script for the new story generation endpoint."""
...
def test_child_story():
    """Test generating a child-only story."""
    print("\n=== Testing Child Story Generation ===")
...
def test_hero_story():
    """Test generating a hero story."""
    print("\n=== Testing Hero Story Generation ===")
    ...
    child_data = {
        ...
        "age": 8,
        "gender": "male",
        "interests": ["dinosaurs", "robots", "space"],
        "created_at": datetime.now().isoformat(),
        "updated_at": datetime.now().isoformat()
    }
    ...
    try:
        ...
        # Filter English heroes
        english_heroes = [h for h in all_heroes if h.language == "en"]
        if not english_heroes:
            print("No English heroes available in the database")
            return
        
        hero = english_heroes[0]
        hero_id = hero.id
...
def test_combined_story():
    """Test generating a combined story."""
    print("\n=== Testing Combined Story Generation ===")
...
if __name__ == "__main__":
    print("=" * 60)
    print("Story Generation Endpoint Test Suite")
    print("=" * 60)
